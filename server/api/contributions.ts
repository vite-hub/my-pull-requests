export default defineEventHandler(async () => {
  try {
    ...
    // Avoid logging sensitive data; keep enough to diagnose via `wrangler tail`.
    ...
    console.error('[api/contributions] GitHub request failed', {
      status,
    ...
    // If this is already an H3Error (eg. missing token guard), keep its status/message.
